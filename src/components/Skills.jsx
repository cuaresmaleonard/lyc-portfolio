      ...
      <div className="max-w-5xl mx-auto px-8">
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-8">
          {skills.map((skill, index) => (
            <div 
              key={index} 
              className="px-6 py-3 bg-professional-50 dark:bg-gray-800 text-professional-800 dark:text-professional-300 font-medium rounded-full shadow-sm border border-professional-100 dark:border-gray-700 hover:bg-professional-500 hover:text-white dark:hover:bg-professional-500 dark:hover:text-white transition-all duration-300 cursor-default hover:-translate-y-1"
            >
              {skill}
            </div>
          ))}
