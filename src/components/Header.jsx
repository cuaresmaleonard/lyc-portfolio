        ...
        <div className="text-left animate-fade-in-up">
          ...
          <div className="flex gap-4">
            <a
              ...
              className="inline-block bg-professional-600 hover:bg-professional-700 text-white font-semibold py-3 px-8 rounded-full shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300"
            >
              Get In Touch
            </a>
            <a
              href="#experience"
              className="inline-block bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 border border-gray-200 dark:border-gray-700 font-semibold py-3 px-8 rounded-full shadow-sm hover:shadow-md transform hover:-translate-y-1 transition-all duration-300"
            >
              View Work
            </a>
          </div>
