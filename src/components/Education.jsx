      ...
      <div className="max-w-5xl mx-auto px-8">
        ...
        <div className="glass-card dark:bg-gray-800 p-6 md:p-8 border-l-4 border-l-professional-500 dark:border-l-professional-400 dark:border-gray-700 transition-colors">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div className="bg-professional-50 dark:bg-gray-900 px-4 py-1.5 rounded-md border border-professional-100 dark:border-gray-700 text-sm font-semibold text-professional-700 dark:text-professional-300 whitespace-nowrap">
              2016
            </div>
          </div>
        </div>
